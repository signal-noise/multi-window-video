...
[list of issues](https://github.com/signal-noise/multi-window-video/issues).
...
Testing is performed using `jest` and `puppeteer` and is tested on Linux and MacOS with
...
Please send a
[GitHub Pull Request to multi-window-video](https://github.com/signal-noise/multi-window-video/pull/new/master)
...
- You ought to be able to find any previous version easily using GitHub tabs, or
  [Releases](https://github.com/signal-noise/multi-window-video/releases)
